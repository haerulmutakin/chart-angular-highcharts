...
export class AppComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    const data = this.appSvc.get('https://code.highcharts.com/mapdata/countries/id/id-all.js').subscribe( res => {
      console.log(res);
    });
  }
  ...
  doCreateMapChart() {
    ...
    tooltip: {
        ...
        useHTML: true,
        padding: 0,
        pointFormat: 'Propinsi {point.name}<br>' +
            '<span style="font-size:20px; color:#26A69A">{point.value} orang</span>',
        positioner: function () {
            return { x: 0, y: 220 };
        },
        style: {
    ...
    exporting: {
        chartOptions: {
            title: {
                text: 'Sebaran Pendaftar Berdasarkan Wilayah Asal<br>',
                style: {
                    fontSize: '16px',
                    fontWeight: 'bold',
                    fontFamily: 'Roboto, sans-serif'
